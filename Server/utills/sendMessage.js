...
export const sendMessage = async (phone, message) => {
    ...
    const url = `https://bulksmsbd.net/api/smsapi?api_key=${process.env.BULKSMSBD_API_KEY}&senderid=${process.env.BULKSMSBD_SENDER_ID}&number=${numberWithCountryCode}&message=${message}&type=text`;
